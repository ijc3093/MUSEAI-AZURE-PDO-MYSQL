        ...
        if($file_size < 5242880){
            if(move_uploaded_file($file_temp, $location_image)){
                try{
                    // Insert data
                    //$last_id = $db->$stmt1;
                    $qrCodeImage = 'http://localhost/museai/Admin/detail2.php?id=';
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add New museai</h6>
        </div>
        <div class="card-body table table-striped table-dark">
            <div class="card-body">
                ...
                <?php 
                        ...
                        //var_dump($result);
                        echo'<form enctype="multipart/form-data" action="insert_museais.php" method="post" role="form" id="createAccountFor" > 
                        ...
                        echo  '<div class="col-lg-5"><button class="btn btn-primary" type="submit" name="insertmuseai">Submit</button></div>'; 
                        echo '<hr/></form>';  
                    ?>
                </div>
            </div>
