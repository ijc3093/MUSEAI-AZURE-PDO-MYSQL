<?php
    ...
    if(isset($_GET['deleteEvent'])){
        $db->admin_Delete("event", $_GET['id'], "idmuseai");
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit museai</h6>
        </div>
                ...
                <?php
                    ...
                    echo'<form enctype="multipart/form-data" action="" method="post" role="form">';
                        echo'<div class="form-group row">';
                                ...
                                echo $venue . ' <br><br><a href="museais.php?back=true" class="btn btn-secondary" class="form-control" value="Cancel" required>Back</a>
