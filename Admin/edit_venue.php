<?php
    ...
    if($_SESSION['userRole'] == 2 || $_SESSION['userRole'] == 1){
        $result = $db->get_Manager_museais($_SESSION['userRole']);
        
        foreach($result as $post){
            if($post['idmuseai'] == $_GET['id']){
                $allowed = true;
                break;
            }
        }
    ...
    if(isset($_POST['edit'])){
        ...
        $_POST['museai'] = sanitize_input($_POST["museai"]);
    ...
    function back(){
        //$_SESSION = array(); // destroy all venue data
        session_destroy(); // compelte erase venue
        //header("location: http://serenity.ist.rit.edu/~ijc3093/ISTE-341/Project1/museai.php");
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <?php
                    //Print all museais tied to the manager or admin
                    //var_dump($username);
                    ...
                    echo'<form action="" method="post" role="form">';
                        ...
                        echo'<div>';
                                ...
                                <div class="col-lg-5">
                                <input type="text" class="form-control" name="museai" value="' . $post["capacity"] . '" required><br>
                                </div>';
                                ...
                                <div class="col-lg-5">
                                <input class="btn btn-success" href="museais.php?back=true" type="submit" name="edit" class="form-control" value="Save Changes" required>&nbsp;';
                                echo'</div>';
